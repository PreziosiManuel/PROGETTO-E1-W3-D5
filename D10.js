...
*/
const me = { name: "Manuel", surname: "Preziosi", age: 25 };
console.log(me);
...
console.log(splitMe("prova split"));

/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare senza l'ultimo.
*/
function deledeOne(str, removeChar) {
  if (removeChar === true) {
    return str.slice(1);
  } else {
...
console.log(deledeOne("prova prova", true));
...
console.log(onlyLetters("ciao312 ciao321"));
/* ESERCIZIO 6
...
console.log(isThisAnEmail("prova@prova.com"));
...
function whatDayIdIt() {
  const today = new Date();
  const daysOfWeek = ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"];
  const dayIndex = today.getDay();
  return daysOfWeek[dayIndex];
}
console.log("Oggi è", whatDayIdIt());
...
function howManyDays(date) {
  ...
  const timeDifference = currentDay - date;
  const daysDifference = Math.floor(timeDifference / (1000 * 60 * 60 * 24));
  return daysDifference;
}
const date = new Date("08 18 1998");
const daysElapsed = howManyDays(date);
console.log("Sono trascorsi" + " " + daysElapsed + " " + "giorni dalla mia data di nascita.");
